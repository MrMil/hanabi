    ...
    if tokens.clues > 0:
        for i in range(len(hands) - 1):
            ...
            if player_ranks:
                ...
                return state, Clue.create(player, 'rank', max(player_ranks)), 'Given actionable rank clue'
            if player_suits:
                return state, Clue.create(player, 'suit', player_suits.pop()), 'Given actionable suit clue'
